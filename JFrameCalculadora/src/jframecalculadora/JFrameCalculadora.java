...
public class JFrameCalculadora extends JFrame{
    ...
    private void inicializarComponentes(){
        ...
        JButtonC btnMM = new JButtonC("+/-", dim, Color.pink);
        JButtonC btnMulti = new JButtonC("*", dim, Color.orange);
        JButtonC btn7 = new JButtonC("7", dim, Color.pink);
        JButtonC btn8 = new JButtonC("8", dim, Color.pink);
        JButtonC btn9 = new JButtonC("9", dim, Color.pink);
        JButtonC btnDiv = new JButtonC("/", dim, Color.orange);
        JButtonC btn4 = new JButtonC("4", dim, Color.pink);
        JButtonC btn5 = new JButtonC("5", dim, Color.pink);
        JButtonC btn6 = new JButtonC("6", dim, Color.pink);
        JButtonC btnMinus = new JButtonC("-", dim, Color.orange);
        JButtonC btn1 = new JButtonC("1", dim, Color.pink);
        JButtonC btn2 = new JButtonC("2", dim, Color.pink);
        JButtonC btn3 = new JButtonC("3", dim, Color.pink);
        JButtonC btnPlus = new JButtonC("+", dim, Color.orange);
        JButtonC btn0 = new JButtonC("0", dim, Color.pink);
        JButtonC btnPoint = new JButtonC(".", dim, Color.orange);
        JButtonC btnEquals = new JButtonC("=", dim, Color.orange);
        JButtonC btnAcerca = new JButtonC("?", dim, Color.LIGHT_GRAY);
